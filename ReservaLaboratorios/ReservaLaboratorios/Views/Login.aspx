<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ReservaLaboratorios.Views.Login" %>
...
<head>
    ...
    <link rel="stylesheet" href="../Content/CSS/login_diseño.css" />

    <script type="text/javascript">
        function mostrarNotificacion(tipo, mensaje, url) {
            if (tipo === "success") {
                iziToast.success({
                    title: 'Éxito',
                    message: mensaje,
                    position: 'topRight',
                    onClosed: function () {
                        window.location.href = url; // Redirige después de cerrar la notificación
                    }
                });
            } else if (tipo === "error") {
                iziToast.error({
                ...
                <div class="col-sm-12">
                    ...
                    <form id="form1" runat="server" class="md-float-material form-material">
                        ...
                        <div class="text-center">
                            <img src="../images/static/logo-blanco-universidad.png" alt="logo.png" style="width: 30%;" />
                        </div>
