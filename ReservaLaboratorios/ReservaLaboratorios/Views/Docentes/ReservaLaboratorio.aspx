<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/SistemaLaboratorio.Master" AutoEventWireup="true" CodeBehind="ReservaLaboratorio.aspx.cs" Inherits="ReservaLaboratorios.Views.Docentes.ReservaLaboratorio" %>
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <!--Importacion de los archivos de estilo-->
    <link href="<%= ResolveUrl("~/Content/CSS/reservaLaboratorio.css") %>" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        <!--Titulo de la pagina-->
    <div class="title-content">
        <h5 class="title">Reservar Laboratorio</h5>
    </div>
