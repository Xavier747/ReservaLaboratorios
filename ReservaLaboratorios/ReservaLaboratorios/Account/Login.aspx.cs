...
namespace ReservaLaboratorios.Account
{
    public partial class Login : Page
    {
            ...
            if (IsValid)
            {
                ...
                if (iniarSecion(usuario, password))
                {
                    ...
                    else
                    {
                        ...
                        {
                            string url = "../Views/Docentes/ListadoLaboratorios.aspx";
        ...
        public bool iniarSecion(string usuario, string password)
        {
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    Session["IdPersonal"] = dr["strCod_Per"].ToString();
                    Session["Nombre"] = dr["strNombre_Per"].ToString();
                    Session["Permisos"] = dr["strNombre_rol"].ToString();
                    rol = dr["strNombre_rol"].ToString();
                    /*Session["TipoResp"] = dr["strTipo_respo"].ToString();
                    Session["EstadoResp"] = dr["bitEstado_respo"].ToString();*/
