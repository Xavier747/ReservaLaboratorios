<%@ Page Title="Laboratorios" Language="C#" MasterPageFile="~/SistemaLaboratorio.Master" AutoEventWireup="true" CodeBehind="Laboratorios.aspx.cs" Inherits="ReservaLaboratorios.Views.Docentes.Laboratorios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="title-content">
        <h5 class="title">Listado de laboratorios</h5>
    </div>
    <br />
