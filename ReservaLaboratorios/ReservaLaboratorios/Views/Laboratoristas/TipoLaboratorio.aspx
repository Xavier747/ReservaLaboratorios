<%@ Page Title="Listado Tipo de Laboratorios" Language="C#" MasterPageFile="~/SistemaLaboratorio.Master" AutoEventWireup="true" CodeBehind="TipoLaboratorio.aspx.cs" Inherits="ReservaLaboratorios.Views.Laboratoristas.TipoLaboratorio" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <!--Titulo de la pagina-->
    <div class="title-content">
        <h5 class="title">Listado Tipo de Laboratorios</h5>
    </div>
    <div class="row">
