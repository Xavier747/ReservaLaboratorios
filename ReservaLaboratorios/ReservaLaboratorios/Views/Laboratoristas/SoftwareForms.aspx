<%@ Page Title="Software" Language="C#" MasterPageFile="~/SistemaLaboratorio.Master" AutoEventWireup="true" CodeBehind="SoftwareForms.aspx.cs" Inherits="ReservaLaboratorios.SoftwareForms" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <!--Titulo de la pagina-->
    <div class="title-content">
        <h5 class="title">Listado de softwares</h5>
    </div>
    <div class="row">
